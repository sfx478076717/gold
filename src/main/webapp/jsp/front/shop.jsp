...
<script type="text/javascript">
    $(function(){
        ...
        $(".plus").click(function(){
            //把该商品的减号设置为蓝色可以点击的状态
            $(this).prevAll("img").eq(0).attr("src","/images/minus_blue.png");
            //获取点击商品的id
        ...
        $(".minus").click(function(){
            ...
            if(map[id] == null || map[id] == 0){
                ...
                if(map[id] == 0){//如果运算减1之后的数量为0，把减号的按钮设置为灰色
                    $(this).attr("src","/images/minus_stop.png");
                }
            }
            return false;
        });
        ...
        $.each($(".number"),function (i,n) {
            ...
            if(map[id] >= 0){
                ...
                $(this).children("img").attr("src","/images/minus_blue.png");
            }
        });
    });
</script>
...
<div id="content_0">
    <c:forEach items="${pageInfo.list}" var="product">
        <div class="content_1">
            <img src="/images/product/${product.pic}" alt="" class="shop_img">
            ...
            <div class="number">
                <img src="/images/minus_stop.png" class="minus">
                <strong>0</strong>
                <img src="/images/plus_blue.png" class="plus">
            </div>
        </div>
    </c:forEach>
</div>
